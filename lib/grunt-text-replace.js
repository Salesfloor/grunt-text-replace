...
exports.replaceText = function (settings) {
  ...
  return gruntTextReplace.replaceTextMultiple(text, replacements, settings);
}
...
gruntTextReplace = {
  ...
  replaceTextMultiple: function (text, replacements, settings) {
  ...
  replaceText: function (settings) {
    ...
    var to = this.expandReplacement(settings.to, settings);
  ...
  expandReplacement: function (replacement, settings) {
    if (typeof replacement === 'function') {
      return this.expandFunctionReplacement(replacement, settings);
  ...
  expandFunctionReplacement: function (replacement, settings) {
    return function () {
